pipeline {
    ...
    stage('Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/KartikSingh970/dockerapp.git'
          }
        }
   ...
   /* stage('SonarQube Analysis') {
    ...
    stage('Docker Login') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'Dockernexus', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
                    sh """
